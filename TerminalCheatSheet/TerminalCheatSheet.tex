...
\subsubsection{SSH Key Expired}

\verb+rm .ssh/known_hosts+ - If you try connecting and it says "WARNING: REMOTE HOST IDENTIFICATION HAS CHANGED!", run this code to just reset all known hosts. Then try connecting again (you'll have to type 'yes' to save it as a known host again)
