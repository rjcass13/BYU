...
- I will identify the most impactful factors by performing FINISH
...
## 4. Proposed Method
In this analysis, a linear model is appropriate. Given the continoues numerical output (price), appears to trend linearly with the only numerical input (mileage), using a linear model is a good fit.  
