...
The research goals require an interpretable model that gives predictions, R-Squared, and that can include mileage*make interactions
...
I will use OLS regression using the format Y = XBeta + epsilon, where epsilon ~ N(0, sigma-squared)
