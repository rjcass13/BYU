...
- We will perform variable selection to determine which factors or impactful to price. Given scale of the data and variables, we will use hybrid stepwise selection (both forward and backwards) to select the model with the appropriate covariates. 
