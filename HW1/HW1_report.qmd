...
output_table = as.data.frame(coef(aic_root))
intervals = as.data.frame(confint(aic_root))
output_table$lower_bound = intervals[,1]
output_table$upper_bound = intervals[,2]
kable(output_table, caption = "Model Variable Coefficients")
```
